...
func (c *dhcpConn) broadcast(respData []byte, peer *net.UDPAddr) (n int, err error) {
	...
	// https://github.com/jqknono/AdGuardHome/issues/3289.  The DHCP
	...
	//
	// See https://github.com/jqknono/AdGuardHome/issues/3480 and
	// https://github.com/jqknono/AdGuardHome/issues/3366.
	//
	// See also https://github.com/jqknono/AdGuardHome/issues/3539.
